...
//        this->finalize();
        ...
        std::vector<glm::vec3> positions;
        positions.emplace_back(-1, -1, 0);      // bottom left corner
        positions.emplace_back(-1,  1, 0);      // top left corner
        positions.emplace_back(1,  1, 0);       // top right corner
        positions.emplace_back(1, -1, 0);       // bottom right corner
