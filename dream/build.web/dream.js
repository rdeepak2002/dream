...
var ASM_CONSTS = {
 ...
 123295: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 123378: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 123447: () => { return window.innerWidth; },  
 123477: () => { return window.innerHeight; }
};
