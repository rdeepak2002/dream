...
var ASM_CONSTS = {
 ...
 128351: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 128434: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 128503: () => { return window.innerWidth; },  
